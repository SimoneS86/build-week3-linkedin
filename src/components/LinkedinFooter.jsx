          ...
          <Row className="mt-3">
            <Col md={2} lg={2} xl={2} className="mb-4">
              ...
              <div>
                <Dropdown className="text-reset">
                  <Dropdown.Toggle className="px-0" variant="none" id="dropdown-basic">
            ...
            <Col md={4} lg={3} xl={3} className="mb-md-0 mb-4">
              ...
              <p>
                ...
                <span style={{ fontWeight: "bold" }}>Domande?</span>
                <br /> Visita il nostro Centro assistenza.
              </p>
              <p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div>
                ...
                <Dropdown>
                  ...
                  <Dropdown.Menu>
                    ...
                    <Dropdown.Item href="#/action-3">Polski (Polacco)</Dropdown.Item>
                    <Dropdown.Item href="#/action-2">Deutsch (Tedesco)</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </div>
            </Col>
